// Importação de Dependências  - tabela dados do supabse
  ...
  async function fetchDataFromSupabase() {
    ...
    if (data && data.length > 0) {
      ...
      if (payload && payload.dados) {
        ...
        const novosDados = {
          Bloco1: dados.Bloco1.nivel_agua,
          Bloco2: dados.Bloco2.nivel_agua,
          Bloco3: dados.Bloco3.nivel_agua
        };

        const dadosAtuais = {
          Bloco1: historicoNiveis.Bloco1[historicoNiveis.Bloco1.length - 1],
          Bloco2: historicoNiveis.Bloco2[historicoNiveis.Bloco2.length - 1],
          Bloco3: historicoNiveis.Bloco3[historicoNiveis.Bloco3.length - 1]
        };

        // Se os dados não mudaram, não atualize o gráfico
        if (
          novosDados.Bloco1 === dadosAtuais.Bloco1 &&
          novosDados.Bloco2 === dadosAtuais.Bloco2 &&
        ...
        if (dados.Bloco1) {
          ...
          historicoNiveis.Bloco1.push(dados.Bloco1.nivel_agua);
          historicoNiveis.Bloco2.push(dados.Bloco2.nivel_agua);
        ...
        if (timestamps.length > 48) {
          ...
          historicoNiveis.Bloco1.shift();
          historicoNiveis.Bloco2.shift();
